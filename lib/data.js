...
/* HOME_FAQS — the questions real businesses actually ask before hiring an
   AI agency. Mined from "people also ask" patterns + Google Search Console
   signals around terms like "AI agency", "AI agents for business",
   "custom CRM", "WhatsApp automation cost". These convert because they
   address the buyer's actual hesitations: money, risk, ownership, ROI. */
export const HOME_FAQS = [
  [
    "What does an AI agency actually do for my business?",
    "An AI agency builds and runs intelligent systems that take repetitive work off your team — automated customer replies, lead qualification, document processing, reporting, follow-ups. SoftiIntel ships these as production software (not slideware), integrated with the tools you already use, with measurable hours saved each month.",
  ],
  [
    "How much does an AI agent or automation project cost?",
    "A focused single-workflow automation (e.g. WhatsApp replies, lead routing) typically lands between $4k–$12k. A custom CRM or multi-agent operations system ranges $15k–$60k depending on scope. We quote a fixed price after a paid 2-week discovery sprint, never hourly — so you know exactly what you're committing to.",
  ],
  [
    "How long until I see results?",
    "First working software in 2–4 weeks. Measurable ROI (hours reclaimed, response times cut, no-shows reduced) typically within the first 8 weeks for automations and 12 weeks for full agent or CRM builds. Most automation projects pay for themselves inside 90 days.",
  ],
  [
    "Will AI agents replace my team?",
    "No — they replace the boring half of your team's job. Inbox triage, follow-ups, data entry, reporting. Your people keep the judgement calls, the relationships, the strategy. Clients consistently report the same number of staff doing significantly more revenue-generating work.",
  ],
  [
    "Is my business data safe? Do you train AI on it?",
    "Your data is yours. We use enterprise model providers (Anthropic, OpenAI, Google) on no-train tiers, host integrations on your own infrastructure where you prefer, and sign mutual NDAs before discovery. Full audit logs ship with every agent we deploy.",
  ],
  [
    "Who owns the code and the AI agents you build?",
    "You do. Full source code, your repository, your cloud account if you want — no vendor lock-in, no per-seat fees, no ransomware-tier pricing if you ever want to leave. The agents and integrations are deliverables, not subscriptions.",
  ],
  [
    "Do I need a big team or technical co-founder to use this?",
    "No. Most of our SME clients have zero in-house developers. We handle deployment, train your team on the dashboards (usually a 1-hour session), and offer optional retainer support. If you can read your sales pipeline today, you can run what we ship.",
  ],
  [
    "What if I don't know which automation will save me the most time?",
    "That's exactly what the 2-week discovery sprint is for. We sit with your team, map where hours actually leak, score every opportunity by impact vs effort, and recommend the one workflow to start with. You leave with a roadmap whether you build with us or not.",
  ],
];
